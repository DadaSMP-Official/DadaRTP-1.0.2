...
**DadaRTP 1.0.2** is a custom Minecraft plugin for Paper/Spigot servers.
...
| Main class | `it.dadasmp.rtp.DadaRtpPlugin` |
...
| --- | --- | --- |
| `dadartp.use` | `true` | Permette di usare /rtp. |
| `dadartp.admin` | `op` | Permette di usare /rtp set <mondo> e /rtp reload. |
